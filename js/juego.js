...
var instrucciones = ['Mueve las piezas del rompecabezas utilizando las teclas de dirección de tu teclado',
    'Cambia las piezas de lugar hasta lograr la figura que se muestra abajo', '¡Buena suerte!'
];
...
function intercambiarPosicionesGrilla(filaPos1, colPos1, filaPos2, colPos2) {
    var grillaTemporal = grilla[filaPos1][colPos1];
    grilla[filaPos1][colPos1] = grilla[filaPos2][colPos2];
    grilla[filaPos2][colPos2] = grillaTemporal;
